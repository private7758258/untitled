...
public class util1 {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "\\Vue\\src\\main\\java");         //自定义代码生成后的存放目录
        gc.setAuthor("ppf");                            //设置项目作者
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/sakila?characterEncoding=utf-8");
